...
export ZSH="/home/micheal/.oh-my-zsh"
...
alias yt-audio-undirect='yt-dlp -f "bestaudio/best" -ciw -o "%(title)s.%(ext)s" -v --extract-audio --audio-format mp3 --audio-quality 0  --yes-playlist'
